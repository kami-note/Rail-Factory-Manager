...
public sealed class InventoryDbContext(DbContextOptions<InventoryDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<StockLocation>(entity =>
        {
            ...
            entity.HasIndex(x => new { x.TenantCode, x.Code }).IsUnique();
        });
        ...
        modelBuilder.Entity<InventoryBalance>(entity =>
        {
            ...
            entity.HasIndex(x => new { x.TenantCode, x.SourceReference }).IsUnique();
        });
        ...
        modelBuilder.Entity<InventoryLedgerEntry>(entity =>
        {
            ...
            entity.HasIndex(x => new { x.TenantCode, x.BalanceId, x.CreatedAt });
        });
